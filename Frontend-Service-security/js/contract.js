function save() {
    ...
    try {
        ...
        $.ajax({
            url: "http://localhost:9000/serviceSecurity/v1/api/contract",
            method: "POST",
            dataType: "json",
...
function deleteById(id) {
    ...
    if (confirm("¿Estás seguro de que quieres eliminar este registro?")) {
        $.ajax({
            url: "http://localhost:9000/serviceSecurity/v1/api/contract/" + id,
            method: "delete",
            headers: {
...
function findById(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#id").val(data.id);
            $("#code").val(data.code);
            $('#date_Star').val(data.dateStar);
            $('#end_data').val(data.dateEnd);
...
function loadEmploy() {
    $.ajax({
        url: "http://localhost:9000/serviceSecurity/v1/api/employed",
        method: "GET",
        dataType: "json",
        success: function (response) {
